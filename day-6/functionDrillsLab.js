...
compareNums = (num1,num2) => {
  ...
  else if (num1 < num2) console.log(`${num1} is smaller than ${num2}.`)
  else (console.log (`They are the same number ${num1}`))
};
compareNums (9,9)
...
let nameGreet = nameCheck(`Jordan`)
